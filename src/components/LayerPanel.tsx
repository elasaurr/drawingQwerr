...
export default function LayerPanel({ layers, activeLayerId, onLayersChange, onActiveLayerChange }: LayerPanelProps) {
		...
		<div className="w-80 bg-gray-900 text-white flex flex-col h-full">
			<div className="p-3 border-b border-gray-700 flex items-center justify-between">
				...
				<div className="flex gap-1">
					<Button variant="ghost" size="icon" className="h-7 w-7 text-white hover:bg-gray-700" onClick={addLayer} title="Add Layer">
					...
					{layers.map((layer, index) => (
						<div
							...
							<div className="p-2 flex items-center gap-2">
								<div className="w-16 h-16 bg-gray-700 rounded border border-gray-600 flex-shrink-0 overflow-hidden">
									{layer.imageData ? (
					...
					<div>
						...
						<div className="flex items-center gap-2">
							...
							<Slider
								...
								onValueChange={(values) => updateLayerOpacity(values[0])}
								min={0}
								max={100}
								step={1}
								className="flex-1"
